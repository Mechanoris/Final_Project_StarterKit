...
public class CasinoDoorLeft : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            if (isOpen)
            {
                transform.parent.Rotate(0f, 0f, 90f); // Example: Rotate the door to open it
            }
            else 
            {
                transform.parent.Rotate(0f, 0f, -90f); // Example: Rotate the door to close it
            }
